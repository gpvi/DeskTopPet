...
| T012 | 提醒系统基础能力 | P0 | done | Agent-A | T005,T007,T011 | 提醒数据、调度、通知闭环 |
| T013 | 待办系统基础能力 | P0 | done | Agent-A | T005,T007 | 待办增删改查与展示 |
| T014 | 剪贴板总结/改写/翻译 | P0 | done | Agent-A | T006,T010,T011 | 打通剪贴板工具与模型能力 |
| T015 | 打开网页/应用/文件夹 | P0 | done | Agent-A | T010,T011 | 完成 MVP 工具调用闭环 |
